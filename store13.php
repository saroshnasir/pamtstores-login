...
<h1 class="text-center" style="color: white;"> STORE 13 </h1>
  <div class="col-md-4">
                    <div class="thumbnail" style="background: transparent !important; border: 2px solid white; color: white;">
                        <a href="https://docs.google.com/forms/d/e/1FAIpQLSfz4yKNebuUpkCJpf2SI_mcyUOomInDQanGyyoud-dlkOJUWg/viewform?pli=1">
          ...
          <div class="caption">
            <p style="color: white;text-align: center;">PLANT A MILLION TREES</p>
                ...
                <div class="col-md-4">
                    <div class="thumbnail" style="background: transparent !important; border: 2px solid white; color: white;">
                        <a href="https://docs.google.com/a/solutions-stores.ca/forms/d/e/1FAIpQLSfGTJhQCNDxhBkYmBgWvytZSLNG5s1ixHbl8OOJ4rkVgQzLxg/viewform">
