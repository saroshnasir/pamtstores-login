...
<h1 class="text-center" style="color: white;">STORE 5</h1>
  ...
  <div class="col-md-4">
                    <div class="thumbnail" style="background: transparent !important; border: 2px solid white; color: white;">
                        <a href="https://pampstores-login.herokuapp.com/store5end.php">
          <img src="img/endcap.png" alt="Nature" style="width:50%; padding-top: 9px;">
          <div class="caption">
            <p style="color: white;text-align: center;">END CAPS</p>
          </div>
        </a>
                    </div>
                </div> 
                ...
                <div class="col-md-4">
                    <div class="thumbnail" style="background: transparent !important; border: 2px solid white; color: white;">
                        <a href="https://pampstores-login.herokuapp.com/store5Signs.php">
          <img src="img/signs.png" alt="Nature" style="width:50%; padding-top: 20px;">
          <div class="caption">
            <p style="color: white;text-align: center;">SIGNS</p>
          </div>
        </a>
                    </div>
                </div>
