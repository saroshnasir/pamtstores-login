...
<h1 class="text-center" style="color: white;">STORE 5</h1>
  ...
  <div class="col-md-4">
                    <div class="thumbnail" style="background: transparent !important; border: 2px solid white; color: white;">
                        <a href="https://docs.google.com/forms/d/e/1FAIpQLSdaRwYPPlrSStSdwDXza8Slk_x0KxHnY3yVUKyaVQ6dCQYj-g/viewform?pli=1">
          ...
          <div class="caption">
            <p style="color: white;text-align: center;">PLANT A MILLION TREES</p>
                ...
                <div class="col-md-4">
                    <div class="thumbnail" style="background: transparent !important; border: 2px solid white; color: white;">
                        <a href="https://docs.google.com/a/solutions-stores.ca/forms/d/e/1FAIpQLSfT44bxs_hKoH3yspcRFhcEtv58P2KDuGld9P4rTU5C_Xpz7A/viewform">
   ...
   <div class="col-md-4">
                    <div class="thumbnail" style="background: transparent !important; border: 2px solid white; color: white;">
                        <a href="https://pampstores-login.herokuapp.com/store5:1.php">
          <img src="img/holidaysale.png" alt="Nature" style="width:50%; padding-top: 20px;">
          <div class="caption">
            <p style="color: white;text-align: center;">HOLIDAY SALE 2017</p>
          </div>
        </a>
                    </div>
                </div>
