...
<h1 class="text-center" style="color: white;">STORE 5</h1>
  ...
  <div class="col-md-4">
                    <div class="thumbnail" style="background: transparent !important; border: 2px solid white; color: white;">
                        <a href="">
          <img src="img/sheet.png" alt="Nature" style="width:50%; padding-top: 20px;">
          <div class="caption">
            <p style="color: white;text-align: center;">SHEET INFORMATION</p>
          </div>
        </a>
                    </div>
                </div> 
                ...
                <div class="col-md-4">
                    <div class="thumbnail" style="background: transparent !important; border: 2px solid white; color: white;">
                        <a href="">
          <img src="img/image.png" alt="Nature" style="width:50%; padding-top: 117px;">
          <div class="caption">
            <p style="color: white;text-align: center;">PHOTOS</p>
          </div>
        </a>
                    </div>
                </div>
